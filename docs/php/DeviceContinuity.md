...
**Full Class Name:** `Starisian\Sparxstar\Sirus\core\DeviceContinuity`
...
### `__construct(private readonly DeviceRepositoryInterface $repository)`
...
### `registerDevice(string $fingerprint_hash, array $environment_data)`
